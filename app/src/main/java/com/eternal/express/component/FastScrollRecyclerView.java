...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
     ...
     * scroller.
     *
     * 此控件可以显示recyclerview当前滚动状态。 我们在onUpdateScrollbar（）中使用
     * 和scrollToPositionAtProgress（）来确定回收器视图的滚动位置
     * 我们可以计算出滚动条的外观，以及快速跳转到哪里
     * 滚轮。
     */
    public static class ScrollPositionState {
        // The index of the first visible row
        public int rowIndex;
        // The offset of the first visible row 偏移量
