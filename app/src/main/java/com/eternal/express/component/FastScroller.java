package com.eternal.express.component;
...
import com.eternal.express.interfaze.OnFastScrollStateChangeListener;
import com.eternal.express.util.DensityUtil;
...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        try {
            ...
            int thumbColor = typedArray.getColor(R.styleable.FastScrollRecyclerView_fastScrollThumbColor, ContextCompat.getColor(context, R.color.colorPrimary));
            int popupBgColor = typedArray.getColor(R.styleable.FastScrollRecyclerView_fastScrollPopupBgColor, ContextCompat.getColor(context, R.color.colorPrimary));
